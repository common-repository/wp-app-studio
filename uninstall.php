...
$options_to_delete = Array('wpas_default_entities', 'wpas_default_roles', 'wpas_passcode_email', 'wpas_apps_submit','wpas_app_key_list','wpas_version','wpas_data_version','wpas_licenses','wpas_license_status','wpas_license_error');
